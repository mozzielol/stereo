...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == 'train':
        ...
        cache = (sample_mean, sample_var, x_est, x, gamma, beta, eps)
        #######################################################################
        #                           END OF YOUR CODE                          #
        #######################################################################
    elif mode == 'test':
        ...
        #######################################################################
        x_est = (x - running_mean) / (np.sqrt(running_var))
        out = gamma * x_est + beta
        #######################################################################
        #                          END OF YOUR CODE                           #
        #######################################################################
...
def batchnorm_backward(dout, cache):
    ...
    # might prove to be helpful.                                              #
    ###########################################################################
    (sample_mean, sample_var, x_est, x, gamma, beta, eps) = cache
    N,D = dout.shape

    dbeta = np.sum(dout, axis=0)
    dgamma = np.sum(x_est * dout, axis=0)
